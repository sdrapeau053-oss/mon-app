  ...
  return (
    <main style={{ maxWidth: 800, margin: "0 auto", padding: 24, minHeight: "100vh", background: "#2a2118", boxShadow: "0 0 0 100vmax #2a2118", clipPath: "inset(0 -100vmax)" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", gap: 16, flexWrap: "wrap", marginBottom: 28 }}>
        ...
        <div style={{ display: "flex", gap: 12, rowGap: 8, flexWrap: "wrap", justifyContent: "flex-end", maxWidth: "100%" }}>
          ...
          <div key={tome.id} style={{ marginBottom: 28 }}>
            ...
            {renommerTomeInput?.id === tome.id ? (
              ...
              >
                ...
                >
                  <span className="tome-title" style={{ fontSize: 15, color: "#efe5d4" }}>{tome.titre}</span>
                  <span style={{ fontSize: 12, color: "rgba(239, 229, 212, 0.62)" }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                  {supprimerTomeConfirm === tome.id ? (
                    <>
                      <span style={{ fontSize: 11, color: "#c0392b" }}>Supprimer ce tome ?</span>
                      <button
                        onClick={() => supprimerTome(tome.id)}
                        style={{ fontSize: 11, padding: "3px 10px", background: "#c0392b", color: "white", border: "none", borderRadius: 4, cursor: "pointer" }}
                      >
                        Confirmer
                      </button>
                      <button
                        ...
                        style={{ fontSize: 11, color: "rgba(239, 229, 212, 0.7)" }}
                      >
                        Annuler
                      </button>
                    </>
                    ...
                    >
                      ...
                      {renommerInput?.tomeId === tome.id && renommerInput.ancienNom === chapitre ? (
                        ...
                        >
                          ...
                          >
                            <span style={{ fontSize: 13, color: "#1a1612" }}>{chapitre}</span>
                            <span style={{ fontSize: 11, color: vide ? "rgba(80, 65, 50, 0.6)" : "#1a1612" }}>
                          ...
                          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                            {supprimerConfirm?.tomeId === tome.id && supprimerConfirm.chapitre === chapitre ? (
                              ...
                              <>
                                  ...
                                  return (
                                    <button
                                      ...
                                      style={{
                                        ...
                                        padding: "2px 10px",
                                        background: "none",
                                        color: analyse?.result ? tome.color : "rgba(80, 65, 50, 0.7)",
                                        border: `1px solid ${analyse?.result ? tome.color + "88" : "rgba(198, 169, 126, 0.3)"}`,
                                        borderRadius: 4,
                                ...
                                {!vide && (
                                  <span style={{ fontSize: 11, color: "rgba(80, 65, 50, 0.6)" }}>{chapOuvert ? "▲" : "▼"}</span>
                                )}
                              </>
                            )}
                          </div>
                          ...
                          {fragsduChapitre.map((f) => {
                            ...
                            return (
                              <div
                                ...
                                style={{
                                  marginBottom: 6,
                                  border: `1px solid ${fragOuvert ? tome.color + "88" : "rgba(198, 169, 126, 0.3)"}`,
                                  borderRadius: 6,
                                  overflow: "hidden",
                              ...
                              >
                                <div
                                  style={{
                                    ...
                                    alignItems: "center",
                                    padding: "8px 14px",
                                    background: fragOuvert ? `${tome.color}0e` : "#f5f0e8",
                                  }}
                                >
                                  <button
                                  ...
                                  <div style={{ display: "flex", alignItems: "center", gap: 10, marginLeft: 12, whiteSpace: "nowrap" }}>
                                    ...
                                    <span style={{ fontSize: 11, color: "rgba(80, 65, 50, 0.6)", cursor: "pointer" }} onClick={() => toggleFragment(f.id)}>
                                      {fragOuvert ? "▲" : "▼"}
                                    </span>
                                  </div>
                                </div>
                                ...
                                {deplacerOuvert !== null && sameFragmentId(deplacerOuvert, f.id) && (
                                  <div style={{ padding: "10px 14px", borderTop: `1px solid ${tome.color}22`, background: "#f5f0e8", display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
                                    <span style={{ fontSize: 11, color: "rgba(80, 65, 50, 0.7)" }}>Déplacer vers :</span>
                                    <select
                                      defaultValue=""
                                      onChange={(e) => {
                                      ...
                                      style={{ fontSize: 12, padding: "4px 8px", border: "1px solid rgba(198, 169, 126, 0.3)", borderRadius: 6, cursor: "pointer", fontFamily: "Georgia, serif", color: "#1a1612" }}
                                    >
                                ...
                                {fragOuvert && (
                                  <div style={{ padding: "12px 16px", borderTop: `1px solid ${tome.color}33`, background: "#f5f0e8" }}>
                                    <p style={{ fontSize: 14, lineHeight: 2, whiteSpace: "pre-wrap", color: "#1a1612", margin: 0 }}>{f.texte}</p>
                                    <p style={{ fontSize: 11, color: "rgba(80, 65, 50, 0.6)", marginTop: 10, marginBottom: 0 }}>
