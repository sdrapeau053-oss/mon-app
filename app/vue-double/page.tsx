    ...
    <div style={{ display: "flex", flexDirection: "column", height: "100vh", background: "var(--bg-main)" }}>
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 16, minWidth: 0, overflow: "hidden" }}>
          ...
          <Link href="/atelier" style={{ fontSize: 12, color: "var(--primary)", flexShrink: 0 }}>Atelier IA</Link>
          <span style={{ color: "var(--border-soft)", flexShrink: 0 }}>|</span>
          <span style={{ fontSize: 13, color: "var(--text-soft)", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", minWidth: 0 }}>
            {tomeActuel?.titre ?? "—"}
