    ...
    <main className="internal-page">
      ...
      <header className="internal-header" style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 16 }}>
        <div>
          ...
          <h1 className="internal-title" style={{ fontStyle: "italic" }}>{t.analyserDemande}</h1>
          <p className="internal-subtitle">{t.collerMessage}</p>
        </div>
      ...
      {/* Zone de saisie */}
      <SystemPanel ariaLabel={t.messageClient} compact>
        <SystemSectionHeader eyebrow={t.messageClient} title={lang === "fr" ? "Brief client" : "Client brief"} />
        <textarea
      ...
      <SystemPanel ariaLabel={t.configurerTarifs} compact>
        <SystemSectionHeader
          actions={(
          ...
          eyebrow={t.configurerTarifs}
          title={lang === "fr" ? "Tarifs et coefficients" : "Rates and coefficients"}
        />
